...
$sql="Select count(*) q From tbl_pendiente_blindaje where ejecutivo='$iduser' and FINAL<>'FINALIZADA' and Marca='S' $sql_where";
...
?>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                    $sql="Select pb.id,COMUNA,RUT,NMRO_ORDEN,FECHA_OT,FECHA_COMPROMISO,CODI_HORARIO,bb.desde,CONTEXTO,ESTD_ACTIV,ESTADO_REAL,GESTION_HD,FINAL,MARCA From tbl_pendiente_blindaje pb inner join tbl_blindaje_bloques bb on pb.CODI_HORARIO=bb.bloque where ejecutivo='$iduser' and FINAL<>'FINALIZADA' and Marca='S' $sql_where order by FECHA_COMPROMISO,bb.desde,NMRO_ORDEN Asc limit $offset, $rowsPerPage ";
                       ...
                       echo"<tr id='tr-".$r_pend->id."' >";
                            ...
                            echo "<td><div id='accion-".$r_pend->id."'>";
                                echo "<select id='marca-".$r_pend->id."' onchange=\"ejecutar_accion_orden('".$r_pend->id."','N')\">";
                                    ...
                                    echo "<option>MOVER A REVISIÓN</option>";
                                echo "</select>";
                            echo "</div></td>";
                        echo"</tr>";
                    }
